...
const relics = [
  { id: "01", title: ["NIGHT", "SHIFT"], kind: "Product interface", signal: "98.4", year: "2025", copy: "A command surface for teams moving faster than their dashboards. Rebuilt around rhythm, focus, and zero-noise decisions.", tags: ["React", "Motion", "Systems"], image: "/ichigo-reiatsu-hero.webp", accent: "#d84242" },

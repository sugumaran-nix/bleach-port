...
type Cue = "entry" | "hover" | "select" | "menu" | "transmission" | "bankai";
...
export default function Soundboard() {
  ...
  useEffect(() => {
    ...
    const onCue = (event: Event) => {
      ...
      output.gain.exponentialRampToValueAtTime(cue === "transmission" || cue === "bankai" ? 0.05 : 0.028, now + 0.012);
      ...
      const base = cue === "entry" ? 130 : cue === "select" ? 280 : cue === "transmission" ? 92 : cue === "bankai" ? 54 : cue === "menu" ? 190 : 420;
      oscillator.frequency.setValueAtTime(base, now);
      oscillator.frequency.exponentialRampToValueAtTime(base * (cue === "entry" || cue === "bankai" ? 1.8 : 0.75), now + (cue === "entry" || cue === "bankai" ? 0.42 : 0.14));
      oscillator.connect(output);
      oscillator.start(now);
      oscillator.stop(now + (cue === "entry" || cue === "bankai" ? 0.58 : 0.2));
      if (cue === "entry" || cue === "select" || cue === "bankai") {
